...
export default function Home() {
  return (
    <>
      <div className='flex items-start justify-between mt-16 px-16 relative min-h-[80vh] w-full gap-16'>
        ...
        <Image
          ...
          className='inline-block absolute left-1/2 -translate-x-1/2 top-4'
        />
