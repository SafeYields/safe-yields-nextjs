  ...
  return (
    <>
      ...
      >
        ...
        <div className='fixed aspect-[695/692] md:max-w-4xl max-w-lg mx-auto w-full lg:top-1/2 top-3/4 left-1/2 -translate-x-1/2 -translate-y-3/4 lg:-translate-y-1/2'>
          <Image
            src='/images/hero.png'
            fill
