  ...
  return (
    <div className='my-8 flex w-full flex-col items-center justify-center gap-8'>
      <div className='flex w-full max-w-lg flex-col justify-center lg:flex-row lg:gap-2'>
        <div className='flex flex-row items-center lg:border-l-2 lg:border-t-0 border-t-2 border-[#4CFAC7] text-[#4CFAC7] px-3 py-4 min-w-32'>
        ...
        <div className='flex flex-col items-center gap-4 lg:border-l-2 lg:border-t-0 border-t-2 border-[#4CFAC7] px-3 py-4 text-[#4CFAC7] min-w-32'>
        ...
        <div className='flex flex-col items-center gap-4 lg:border-x-2 lg:border-y-0 border-y-2 border-[#4CFAC7] px-3 py-4 text-[#4CFAC7] min-w-32'>
          <span className='text-sm font-medium text-white'>
            Today&apos;s PNL
          </span>
          <span className='text-xl font-bold'>
